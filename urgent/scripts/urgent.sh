#!/bin/bash
# urgent.sh: triple Submarine alert with 1.333s pauses between plays.
#
# Use for "I REALLY need your attention" moments. The urgent SKILL.md
...
# Usage: urgent.sh "deploy gate waiting on approval"
...
printf '[%s] URGENT triple-ping reason=%q ppid=%s ppid_cmd=%q\n' \
